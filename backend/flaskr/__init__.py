  ...
  def play_quiz():
    ...
    try:
      ...
      if quiz_category == 0:
        ...
        questions_per_category = Question.query.filter(Question.category == quiz_category).all()
      
      question_list = [question for question in questions_per_category if question.id not in previous_questions]
